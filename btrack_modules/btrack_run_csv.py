# Module that runs btrack on a CSV
...
def run_btrack(input_csv:str, config:str, output:str) -> None:
    """
    ...
    with btrack.BayesianTracker() as tracker:
        ...
        # open objects from csv
        objects = btrack.io.import_CSV(input_csv)
        ...
        btrack.io.export_CSV(filename=output, tracks=tracks)
...
def main() -> None:
    ...
    run_btrack(input_csv=input_file,
               config=config_file,
               output=output)
