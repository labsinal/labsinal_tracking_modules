...
from ultrack.core.export import to_trackmate
...
def get_args_dict() -> dict:
    ...
    parser.add_argument("-o", "--output",
                        ...
                        required=True,
                        dest="output",
                        help="Output file to save tracking output (.xml)")
...
def track_segmentation(video:Array, config_file:MainConfig, output_file:str) -> DataFrame:
    """
    ...
    to_trackmate(config_file, Path(output_file))
...
def main() -> None:
    ...
    track_segmentation(video=segmentation_video, config_file=conf_obj, output_file=output_file)
    print("Done!")
